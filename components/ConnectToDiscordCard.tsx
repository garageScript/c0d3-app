...
import { ModalCard, ModalCardProps, ModalSize } from './ModalCard'
import NavLink from './NavLink'
import LogoutContainer from './LogoutContainer'

type ConnectToDiscordCardProps = Pick<ModalCardProps, 'show' | 'hideable'>
...
const ConnectToDiscordCard: React.FC<ConnectToDiscordCardProps> & WithLayout =
  ({ show }) => {
    return (
      <ModalCard
        hideable={false}
        ...
        <div className="m-5">
          ...
          <div className="mt-3">
            <p>
              ...
              , or create one if you don&apos;t already have one. Our students
              and mentors use Discord to communicate and help each other, give
              you feedback on your challenges, and sometimes do virtual
              hangouts.
            </p>
            <p>
            ...
            <p>
              ...
              Discord, we&apos;d love to hear about it! Your thoughts will help
              us make more informed decisions about our community platform and
              if the reasons are compelling enough, may inspire us to switch to
              an alternative.
            </p>
          </div>
