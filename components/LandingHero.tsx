    ...
    <div className="container text-center">
      ...
      <div className="row justify-center mt-5">
        <div className="col-md-8 offset-md-2">
          <h1 style={{ fontWeight: 900 }} className="display-4">
      ...
      <div className="row mt-5">
        <div className="col-md-4">
          ...
          <h4>Updated and modern curriculum</h4>
          <p>
        ...
        <div className="col-md-4">
          <img src="https://dummyimage.com/212x141/000/fff"></img>
          <h4>Real-time help from your mentors and peer</h4>
          <p>
        ...
        <div className="col-md-4">
          ...
          <h4>Practical experience by working with other engineers</h4>
          <p>
