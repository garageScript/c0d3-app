...
You may have noticed that some of the exercises and challenges in JS0 are actually
closure examples.
...
method to display or print out what is going on in the console. Instead of writing
...
2. **Function Shape:** `love` does not take in any parameters and does not return
   anything
...
the pizza is done before doing something else? Probably not. You will probably do
