...
> This section (Objects) is moved here from JS3. If this section is
...
<ChallengeBar
  href="/curriculum/1"
  description="Complete the first seven JS0 challenges"
...
export default ({ children }) => (
  <Layout
    ...
    lessonId="1"
    subLessons={['Primitive data and operators', 'Functions and execution context']}
  >
    {children}
  </Layout>
)
