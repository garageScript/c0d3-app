...
[already say that functions are the most important concept in JavaScript](https://www.notion.so/JS-0-Foundations-a43ca620e54945b2b620bcda5f3cf672#420f9a48361e4cc88c2171c63525d050)?!
...
object. Go
[here](https://www.notion.so/JS-3-Objects-3df846eaf0404fe6b012208773063a04#ed309fd8496a44bbad12714ea879889d)
to read more on prototypes.
...
***Note***: *It's important to understand that there is a distinction between an
object's prototype (available via Object.getPrototypeOf(obj), or via the
deprecated* ***proto*** *property) and the prototype property on constructor
functions.*

*The constructor function Foobar() has its own prototype, which can be found by
...
property. Thus Object.getPrototypeOf(fooInstance) === Foobar.prototype.*
