...
Now that you know your way around the terminal, you can start setting up your
computer to write some code.

## Code Editor

We will use VS Code (Visual Studio Code) for code editing.
[VS Code](https://code.visualstudio.com/) is a open source-code editor for
macOS, Linux, and Windows. [Install VS Code](https://code.visualstudio.com/).
...
> in the current folder. For macOS, look below to see how to set it up.

To set up this terminal shortcut in macOS, open up VS Code, and use
`cmd + shift + p` to open Search. Type in `shell`, and install the 'code'
command.
